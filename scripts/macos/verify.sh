...
if [[ "${check_installed}" == true ]]; then
  ...
  for command_name in \
    ...
    tsc eslint bash-language-server claude codex aerospace borders; do
  ...
  for app_name in \
    Ghostty.app Vivaldi.app ChatGPT.app Claude.app Discord.app Docker.app "IntelliJ IDEA.app" "Visual Studio Code.app" \
